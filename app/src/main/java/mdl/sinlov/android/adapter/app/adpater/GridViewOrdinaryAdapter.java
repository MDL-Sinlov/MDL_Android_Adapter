 ...
 */
public class GridViewOrdinaryAdapter extends MDLAdpater<ItemOrdinary> {
    public GridViewOrdinaryAdapter(Context context) {
        super(context, R.layout.item_half_ordinary);
    }
